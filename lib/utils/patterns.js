...
export function transformTreeData(patterns, url = '', actions = []) {
  ...
  return actionKeys.map(key => {
    ...
    return {
      ...
      isOpen: false,
      treeData: transformTreeData(itemPatterns),
      hasChild: hasChild(itemPatterns),
      actions: itemActions,
      switch: itemPatterns.switch,
    }
  })
}
